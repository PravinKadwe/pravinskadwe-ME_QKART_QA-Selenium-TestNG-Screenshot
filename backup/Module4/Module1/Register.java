...
public class Register {
    ...
    public Boolean registerUser(String Username, String Password, Boolean makeUsernameDynamic)
        ...
        // SLEEP_STMT_12: Wait for new user to get created in the backend
        // Thread.sleep(3000);

        // Replace Thread.sleep(5000) with an explicit wait
        WebDriverWait wait = new WebDriverWait(driver, 5); // Wait for up to 5 seconds
        wait.until(ExpectedConditions.presenceOfElementLocated(By.id("notistack-snackbar"))); // Wait until the alert pop-up "notistack-snackbar"
